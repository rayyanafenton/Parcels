...
/**
 * Servlet implementation class StaffParcelListServlet
 */
@WebServlet("/staff-parcel-list")
public class StaffParcelListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StaffParcelListServlet() {
        super();
