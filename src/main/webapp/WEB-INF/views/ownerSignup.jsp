...
<head>
<meta charset="UTF-8">
<title>Parcels - Owner Signup</title>
...
<body>
	...
	<div class="center-nav">
		<div class="nav-option">
			<a href="owner-signup" class="option-btn-1">Sign up</a> 
			<a href="owner-login" class="option-btn-2">Login</a>
		</div>
	</div>
	...
	<div class="wrapper">
		...
		<form action="<%= request.getContextPath() %>/owner-signup" method="post">
			<div class="form-row">
