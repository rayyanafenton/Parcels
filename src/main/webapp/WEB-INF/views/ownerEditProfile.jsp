...
<head>
<meta charset="UTF-8">
<title>Parcels - Owner Edit Profile</title>
...
%>
	...
	<div class="center-nav">
		<div class="nav-option">
			<a href="owner-view-profile?email=${email}" class="option-btn-2">View Profile</a> 
			<a href="owner-edit-profile?email=${email}" class="option-btn-1">Edit Profile</a>
		</div>
	</div>
	...
	<div class="wrapper">
		...
		<form action="owner-edit-profile" method="post">
