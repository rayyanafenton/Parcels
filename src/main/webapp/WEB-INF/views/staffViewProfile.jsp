...
%>
	...
	<div class="center-nav">
		<div class="nav-option">
			<a href="staff-view-profile?email=${email}" class="option-btn-1">View Profile</a>  
			<a href="staff-edit-profile?email=${email}" class="option-btn-2">Edit Profile</a>
		</div>
	</div>
	...
	<div class="wrapper">
		...
		<form>
			...
			<div class="form-row">
				...
				<div class="input-column">
					<input type="text" id="role" name="role" value=<%=staff.getRole()%>>
				</div>
			</div>
